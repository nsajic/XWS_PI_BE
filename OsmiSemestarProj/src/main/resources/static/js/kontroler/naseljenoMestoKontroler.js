var naseljenoMestoKontroler = angular.module('xws_pi_bezb.naseljenoMestoKontroler', []);

naseljenoMestoKontroler.controller('naseljenoMestoCtrl', function($scope, naseljenoMestoServis, $window, $location) {
	var vm = this;
	...
	$scope.dodajNaseljenoMesto = function() {
		...
		naseljenoMestoServis.dodajNaseljenoMesto(naseljenoMesto).success(function(data) {
			$scope.naseljenaMesta = data;
			$location.path('/naseljenoMesto');
	...
	$scope.izmeniNaseljenoMesto = function(id) {
		...
		naseljenoMestoServis.izmeniNaseljenoMesto(naseljenoMesto).success(function(data) {
			$scope.naseljenaMesta = data;
			$location.path('/naseljenoMesto');
			$scope.idNaseljenogMestaZaIzmenu = -1;
			$scope.setTab(0);
