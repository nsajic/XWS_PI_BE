...
INSERT INTO `xws_pi_bezb`.`medjubankarski_prenos` (`id`, `datum`, `datum_valute`, `iznos`, `obracunski_period_banke_duznika`, `obracunski_period_banke_poverioca`, `swift_kod_banke_duznika`, `swift_kod_banke_poverioca`, `vrsta_poruke`, `banka_posiljalac_id`, `banka_primalac_id`, `valuta_id`) VALUES 
												  ('1', '2017-04-15', '2017-04-15', '123', '123', '3454353', '234234', '56765', '334', '1', '2', '1');


insert into stavka_prenosa (medjubankarski_prenos_id, analitika_izvoda_id) values (1, 1);
insert into stavka_prenosa (medjubankarski_prenos_id, analitika_izvoda_id) values (1, 2);
insert into stavka_prenosa (medjubankarski_prenos_id, analitika_izvoda_id) values (1, 3);
insert into stavka_prenosa (medjubankarski_prenos_id, analitika_izvoda_id) values (1, 1);
insert into stavka_prenosa (medjubankarski_prenos_id, analitika_izvoda_id) values (1, 2);
insert into stavka_prenosa (medjubankarski_prenos_id, analitika_izvoda_id) values (1, 3);
